...
Benutzeroberflächen verwenden \textit{Databinding} zur Anzeige von durch \textit{ViewModels} bereitgestellten Daten.
Diese liegen mehrheitlich in Form von \textit{LiveData} vor, wodurch zudem eine automatische Aktualisierung von Anzeigen möglich ist.
Der für das \textit{Databinding} notwendige Quelltext wird automatisch generiert, wodurch Fehleranfälligkeit reduziert und Entwicklung beschleunigt werden.

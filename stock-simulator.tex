...
Durch Scrollen innerhalb der Ansicht, werden weitere Anlagen sichtbar, falls aus Platzgründen nicht alle darstellbar sind.
...
\autoref{fig:functionality:history:list_closed} zeigt den Aufbau des Bildschirms.
Transaktionen werden in Form von Karten dargestellt.

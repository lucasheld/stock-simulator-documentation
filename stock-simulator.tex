...
Das Einstellungsmenü ist über das Zahnrad in der \textit{Toolbar} aller Screens, au"ser den Einstellungen selbst, erreichbar.
...
Im letzten Abschnitt des Screens werden die bereits gekauften Anlagen aufgelistet (siehe \autoref{fig:functionality:account:depot_quotes}). Durch scrollen innerhalb der Ansicht, werden weitere Anlagen sichtbar, falls aus Platzgründen nicht alle unmittelbar darstellbar sind.

...
Über die \textit{Bottom Navigation} \autocite{bottom_navigation} können Nutzer zwischen den Hauptfeatures Account, Suche, Transaktionsverlauf, Stockbrot und Errungenschaften wechseln (siehe \autoref{fig:functionality:navigation:bottom-navigation}).
...
Das Einstellungsmenü ist über das Zahnrad in der Toolbar von allen Screens, au"ser den Einstellungen selbst sowie den News, erreichbar (siehe \autoref{fig:functionality:navigation:settings}).
...
\begin{figure}[H]
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[height=8cm,keepaspectratio]{./images/navigation/bottom_navigation.png}
		\caption{Bottom Navigation}
		\label{fig:functionality:navigation:bottom-navigation}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[height=8cm,keepaspectratio]{./images/navigation/settings.png}
		\caption{Navigation zu Einstellungen}
		\label{fig:functionality:navigation:settings}
	\end{subfigure}
	\caption{Navigation}
	\label{fig:functionality:navigation}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=7cm,keepaspectratio]{./images/settings/layout.png}

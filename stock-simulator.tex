...
Das Einstellungsmenü ist über das Zahnrad in der Appbar von allen Screens, au"ser den Einstellungen selbst sowie den News, erreichbar (siehe \autoref{fig:functionality:navigation:settings}).

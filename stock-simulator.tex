...
\label{sec:demo}
Um die Funktionen und die Handhabung der Applikation zu demonstrieren, werden einige typische Anwendungsfälle und Transaktion dargestellt. Nach dem Start der Applikation wird dem Nutzer der Account-Bildschirm angezeigt. Wie in \autoref{fig:demo:start} Zu Beginn verfügt der Nutzer über einen Kontostand von 10.000,- \$ und ohne Anlagevermögen, d. h. ein leeres (Wertpapier-) Depot. Die Wertentwicklung seines Gesamtvermögens (Performance) beträgt zu Beginn des Spiels ebenfalls 0.00 \%.

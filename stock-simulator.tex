...
Benutzeroberflächen sind in dieser Anwendung durch \textit{Fragmente} realisiert und ihre Logik in \textit{ViewModels} implementiert.
Von benutzeroberflächenunabhängige Logik residiert in \textit{Repositories}.
Durch diese Trennung es möglich Schichten separat voneinander zu testen.
...
In {ViewModels} ist das Verhalten von Benutzeroberflächen definiert. Sie beziehen ihre Daten aus Datenquellen, welche in Form von \textit{Repositories} implementiert sind.

...
Im Account-Bildschirm bekommt der Benutzer alle Informationen angezeigt, welche seinen Kontostand und sein Depot betreffen (siehe \autoref{fig:functionality:account}). Dieser Bildschirm wird über den Eintrag "`Account"' in der \textit{Bottom Navigation} erreicht.
